...
var _ScrollTopSettings = require("./ScrollTopSettings.js");
...
class ScrollTop extends _react.default.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      listenerOn: false,
    ...
    this.checkProps = () => {
      ...
      let propSet = new Set([...Object.keys(_ScrollTopSettings._scrollTopDefaultProps)], [...Object.keys(defaultStyle)]);
      let propsGood = [true, []];
    ...
    this.createStyle = () => {
      ...
      (0, _ScrollTopSettings._setScrollTopDefault)(defaultStyle);
    ...
    this.handleMouseOut = event => {
      const {
        backgroundColor,
        color
      } = _ScrollTopSettings._scrollTopDefault;
    ...
    this.handleMouseOver = event => {
      const {
        scrollerHover = _ScrollTopSettings._scrollTopHover
      } = this.props;
      const {
        backgroundColor,
        color
...
ScrollTop.defaultProps = _objectSpread({}, _ScrollTopSettings._scrollTopDefaultProps);
